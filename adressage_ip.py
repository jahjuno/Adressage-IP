...
while not re.match(r'2{1}55.\d{1,3}.\d{1,3}.\d{1,3}$', subnet_mask):
    ...
    mask_list = ["255.0.0.0", "255.128.0.0", "255.192.0.0", "255.224.0.0", "255.240.0.0", "255.248.0.0", "255.252.0.0", "255.254.0.0",
                 "255.255.0.0", "255.255.128.0", "255.255.192.0", "255.255.224.0", "255.255.248.0", "255.255.252.0", "255.255.254.0",
                 "255.255.255.0", "255.255.255.128", "255.255.255.192", "255.255.255.224", "255.255.255.248", "255.255.255.252", "255.255.255.254"
                 ]
